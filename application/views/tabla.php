    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="row" style="margin-bottom: 20px;">
               ...
               <div class="col-md-1">
                     <!--<button class="btn btn-block btn-info" id="btn-buscar"><span class="glyphicon glyphicon-search"></span></button>-->
                </div>
                <div class="col-md-2">
                    <button id="crear" class="btn btn-block btn-success" type="button"><span class="glyphicon glyphicon-plus"></span></button>
                </div>
            </div>
            ...
            <nav>
                <ul class="pagination">
                    <?php for($i = 0; $i < $num_total / 5; $i++): ?>
                        <li>
                            <a href="<?= base_url() ?>index.php/<?= $seccion ?>/listar/<?= $i ?>">
                                <?= $i + 1 ?>
                            </a>
                        </li>
                        <?php endfor; ?>
